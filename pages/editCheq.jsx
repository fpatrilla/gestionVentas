...
export default function editCheq({ salesCheqs }) {
  const [query, setQuery] = useState('')
  const [searchResults, setSearchResults] = useState([])
  const [previousCheqs, setPreviousCheqs] = useState(articles)
  ...
  const handleSearch = async (e) => {
    ...
    setPreviousArticles(salesCheqs)
    const response = await fetch(`/api/sales/cheq/search?q=${query}`)
  ...
  const filteredSaleCheqs = searchResults.length ? searchResults : previousCheqs
