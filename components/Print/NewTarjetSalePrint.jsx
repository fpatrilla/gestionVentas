...
const NewTarjetSalePrint = ({   companys, image, name, lastname, product, price, codigoAutorizacion, tipoTarjeta, cuote }) => {
                  ...
                  <div style={{width:"100%"}}>
                     <table style={{ width: "100%", borderCollapse: "collapse", border: "1px solid", textAlign: "left" }}>
                        ...
                        <tr>
                            ...
                            <td style={{ borderRight: "1px solid", padding: "10px" }}> {name} {lastname}</td>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}>{tipoTarjeta}</td>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}> {cuote}</td>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}> {codigoAutorizacion}</td>
...
export default NewTarjetSalePrint;
