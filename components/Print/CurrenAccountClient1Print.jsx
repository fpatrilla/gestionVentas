...
const CurrenAccountClient1Print = ({ companys, image , filteredCurrentAccountClient1, totalPrice }) => {
  ...
  return (
    <div id="print-CurrenAccountClient1Print" style={{ display: 'none' }}>
...
export default CurrenAccountClient1Print;
