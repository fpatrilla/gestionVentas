...
const AccountTicket = ({ image, account, companys  }) => {
...
const formattedDate = `${day}/${month}/${year}`;
    ...
    return (
      <div id="ticket-Account" style={{ width: '80mm', fontFamily: 'Arial', fontSize: '25px', margin: '10px',   display: 'none'  }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '5px', }}>
                  {companys.map((company, index) => (
                    ...
                    <div>
                           <strong><EmailIcon style={{width:"15px", height:"15px" , marginTop:"5px"}}/> Gmail:</strong> {account.gmail}
                    </div>
                  
                    <div>
                        <strong><PasswordIcon style={{width:"15px", height:"15px" , marginTop:"5px"}}/> Contraseña</strong> {account.gmailpass}
                    </div>
                    ...
                    <div>
                           <strong><FacebookIcon style={{width:"15px", height:"15px" , marginTop:"5px"}}/> Facebook:</strong> {account.facebook}
                    </div>
                  
                    <div>
                        <strong><PasswordIcon style={{width:"15px", height:"15px" , marginTop:"5px"}}/> Contraseña</strong> {account.facebookpass}
                    </div>
                    <div style={{width: "280px", margin: "0 auto", textAlign: "center", borderBottom:"1px solid", marginBottom:"4px", marginTop:"4px"}}>
                    </div>
                    <div>
                           <strong><AppleIcon style={{width:"15px", height:"15px" , marginTop:"5px"}}/> icloud:</strong> {account.icloud}
                    </div>
                  
                    <div>
                        <strong><PasswordIcon style={{width:"15px", height:"15px" , marginTop:"5px"}}/> Contraseña</strong> {account.icloudpass}
                    </div>
