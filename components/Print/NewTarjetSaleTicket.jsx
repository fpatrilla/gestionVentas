...
const NewTarjetSaleTicket = ({companys, image, name, lastname, product, price, codigoAutorizacion, tipoTarjeta, cuote }) => {
      ...
      <div id="ticket-sale" style={{ width: '80mm', fontFamily: 'Arial', fontSize: '25px', margin: '10px',   display: 'none'  }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '5px', }}>
                 {companys.map((company, index) => (
                    ...
                    <div>
                           <strong>F. de Pago :</strong> {tipoTarjeta}
                    </div>
                    <div>
                           <strong>Cuotas:</strong> {cuote}
                    </div>
                    <div>
                           <strong>Cod Auto.:</strong> {codigoAutorizacion}
                    </div>
  ...
  export default NewTarjetSaleTicket;
