...
const TechnicalreportPrint = ({ companys, image , technicalreport, firma }) => {
...
const formattedDate = `${day}/${month}/${year}`;
  ...
  return (
    <div id="print-TechnicalreportPrint" style={{ display: 'none' }}>
  ...
  {/* //header */}
          ...
          <div>
            <h1><PersonIcon  width={25} height={25}/>  SR(a) {technicalreport.name} {technicalreport.lastname} </h1>
          </div>
          ...
          <div style={{width:"80%", marginTop:"70px", textAlign:"right"}}>
                <h2>
                Presupuesto de reparación: <MonetizationOnIcon  width={22} height={22} /> {technicalreport.price}
                </h2>
...
export default TechnicalreportPrint;
