...
const PresupuestoTicket = ({name, lastname, price, product, priceTarjet, companys, image }) => {
  ...
  const formattedDate = `${day}/${month}/${year}`;
    ...
    return (
      <div id="ticket-presupuesto" style={{ width: '80mm', fontFamily: 'Arial', fontSize: '25px', margin: '10px',   display: 'none'  }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '5px', }}>
                 {companys.map((company, index) => (
                    ...
                    <div style={{marginTop:"12px"}}>
                        ...
                        <strong><MonetizationOnIcon style={{width:"15px", height:"15px"}}/> Precio Efectivo:</strong> ${price} 
                    </div>
                    <div style={{marginTop:"12px"}}>
                        <strong><CreditCardIcon style={{width:"15px", height:"15px"}}/> Precio Tarjeta:</strong> ${priceTarjet} 
                    </div>
                    <div style={{width: "280px", margin: "0 auto", textAlign: "center", borderBottom:"1px solid", marginBottom:"4px", marginTop:"4px"}}>
                    </div>
  ...
  export default PresupuestoTicket;
