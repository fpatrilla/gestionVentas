...
const SoldArticlePrint = ({
  ...
  return (
    <div id="print-SoldArticlePrint" style={{ display: "none" }}>
                ...
                >
                  <thead style={{ backgroundColor: "gray" }}>
                    <tr>
                      ...
                      >
                        Precio <MonetizationOnIcon width={18} height={18} />{" "}
                      </th>
                    </tr>
                  </thead>
                  <thead>
                ...
                >
                  {companys.map((company, index) => (
                    <div key={company._id} style={{ display: "flex" }}>
                      ...
                      <div style={{ fontSize: "11px", marginRight: "5%" }}>
                        {company.web}
                      </div>
...
export default SoldArticlePrint;
