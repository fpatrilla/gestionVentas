...
const NewSalePrint = ({ name, lastname, product, price, companys, image }) => {
                  ...
                  <div style={{width:"100%"}}>
                     <table style={{ width: "100%", borderCollapse: "collapse", border: "1px solid", textAlign: "left" }}>
                        ...
                        <tr>
                            ...
                            <td style={{ borderRight: "1px solid", padding: "10px" }}> {name}</td>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}>{lastname}</td>
