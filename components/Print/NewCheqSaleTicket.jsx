...
const NewCheqSaleTicket = ({companys, image, product, price, nombre, bank, dador, NumCheq , FechDep, observation    }) => {
      ...
      <div id="ticket-sale" style={{ width: '80mm', fontFamily: 'Arial', fontSize: '25px', margin: '10px',   display: 'none'  }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '5px', }}>
                 {companys.map((company, index) => (
                    ...
                    <div>
                           <strong>Titular</strong> {nombre}
                    </div>
                    <div>
                           <strong>Dador:</strong> {dador}
                    </div>
                    <div>
                           <strong>Banco:</strong> {bank}
                    </div>
                    <div>
                           <strong>N* Cheque:</strong> {NumCheq}
                    </div>
                    <div>
                        <strong>Fecha Cobro</strong> {FechDep}
                    </div>
                    <div>
  ...
  export default NewCheqSaleTicket;
