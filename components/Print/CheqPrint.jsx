...
const CheqPrint = ({   companys, image, salesCheqs    }) => {
...
const formattedDate = `${day}/${month}/${year}`;
  ...
  return (
    <div id="print-Cheq" style={{ display: 'none' }}>
          ...
          <div style={{width:"100%"}}>
                  <div style={{width:"100%"}}>
                     <table style={{ width: "100%", borderCollapse: "collapse", border: "1px solid", textAlign: "left" }}>
                        ...
                        <tr>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}> {salesCheqs.createdAt}</td>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}> {salesCheqs.nombre}</td>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}>{salesCheqs.dador}</td>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}> {salesCheqs.bank}</td>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}> {salesCheqs.NumCheq}</td>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}> {salesCheqs.FechDep}</td>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}> {salesCheqs.product}</td>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}> {salesCheqs.observation}</td>
                            <td style={{ padding: "10px" }}> {salesCheqs.price}</td>
                          </tr>
                        </thead>
