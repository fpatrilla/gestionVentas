...
const OrderPrint = ({ orden, companys, image }) => {
  const formattedDate = new Date(orden.createdAt).toLocaleDateString();

  const portaSimChecked = true; // O false si debe estar desmarcado por defecto
  const simChecked = true; // O false si debe estar desmarcado por defecto
  const tpuChecked = true; // O false si debe estar desmarcado por defecto
  const sdChecked = true; // O false si debe estar desmarcado por defecto
  ...
  {/* //header */}
          ...
          <div style={{  width: "100%", marginTop:"8px"}}>
              <div style={{ width: "100%", fontSize:"18px"}}><span >Orden de Reparación: </span><span style={{fontSize:"30px", fontWeight:"bold" }}>{orden.identifier}</span> 
              ...
              <hr/>
                  <div style={{ width: "100%", textAlign: "justify", display:"flex", marginBottom:"8px" }}>
                        <div style={{ paddingLeft:"1%",  fontSize:"16px",  paddingRight:"3px"}}><span style={{fontWeight:"bold"}}> Cliente:</span> {orden.name} {orden.lastname}</div>
                        <div style={{ paddingLeft:"2%"}}><LocalPhoneIcon style={{ width: "15px", height: "15px", paddingRight:"3px" }} /><span style={{fontWeight:"bold"}}> Telefono:</span> {orden.number}</div>
                        <div style={{ paddingLeft:"2%"}}> <EmailIcon style={{ width: "15px", height: "15px" , paddingRight:"3px" }} /><span style={{fontWeight:"bold"}}> Email :</span> {orden.email}</div>
                  ...
                  <div style={{width:"60%"}}>
                     <div style={{width:"100%", paddingLeft:"3%", paddingRight:"3px"}}>
                      ...
                      <div style={{ marginTop: '10px', paddingLeft:"3%", }}>
                            <input type="checkbox" checked={orden.sim} disabled={true}  /> SIM
                            <input type="checkbox" checked={orden.portaSim} disabled={true} /> Porta SIM
                            <input type="checkbox" checked={orden.tpu} disabled={true} style={{fontWeight:"bold"}} /> TPU
                            <input type="checkbox" checked={orden.sd} disabled={true} /> SD
          ...
          <div style={{width:"100%", textAlign:"end"}}>
              <div style={{display:"flex", width:"100%"}}>
                ...
                <div style={{ marginRight:"3%", marginBottom:"5px",  marginLeft:"auto" , }}>{orden.name} {orden.lastname}
                </div>
              </div>
