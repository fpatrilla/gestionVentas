...
const TarjetPrint = ({   companys, saleTarjets, image }) => {
...
const formattedDate = `${day}/${month}/${year}`;
  ...
  return (
    <div id="print-Tarjet" style={{ display: 'none' }}>
                        ...
                        <div style={{ width: "70%", height: "100%" }}>
                            ...
                            <div key={company._id}>
                                        <div style={{ textAlign: "center" }}>        
                                                <div style={{fontSize:"35px", fontWeight:"bold"}}>{company.companyname}  </div>                                          
          ...
          <div style={{width:"100%"}}>
                  <div style={{width:"100%"}}>
                     <table style={{ width: "100%", borderCollapse: "collapse", border: "1px solid", textAlign: "left" }}>
                        <thead style={{ backgroundColor: "gray" }}>
                          <tr>
                           <th style={{ borderRight: "1px solid", padding: "10px" }}> Fecha  <TodayIcon  width={18} height={18} style={{marginLeft:"6%"}} /></th>
                            <th style={{ borderRight: "1px solid", padding: "10px" }}> Cliente </th>
                            <th style={{ borderRight: "1px solid", padding: "10px" }}>F. de Pago    </th>
                            <th style={{ borderRight: "1px solid", padding: "10px" }}> Cuotas   </th>
                            <th style={{ borderRight: "1px solid", padding: "10px" }}> Cod Auto.  </th>
                        ...
                        <tr>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}> {saleTarjets.createdAt}</td>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}> {saleTarjets.name} {saleTarjets.lastname}</td>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}>{saleTarjets.formaPago}</td>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}> {saleTarjets.cuote}</td>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}> {saleTarjets.codigoAutorizacion}</td>
                            <td style={{ borderRight: "1px solid", padding: "10px" }}> {saleTarjets.product}</td>
                            <td style={{ padding: "10px" }}>$ {saleTarjets.price}</td>
                          </tr>
                        </thead>
