...
export default function CurrenAccountClient1PayModal({
  isOpen,
  closeModal,
  totalPrice,
  currentAccountClient1s,
}) {
  ...
  const handleGuardarClick = async () => {
    try {
      ...
      console.log(request);
      const response = await fetch("/api/currentAccount/client1/rest", request);
    ...
    try {
      if (formaDePago === "Efectivo") {
        ...
        const response = await fetch(
          "/api/currentAccount/client1/rest",
          request
        );
